...
const Teacher = () => {
    ...
    return (
        <div className='section-container'>
            <h1 className="text-3xl lg:text-4xl font-bold flex items-center gap-2 justify-center dark:text-gray-400 p-5"> are you a Teacher or Partner <span className="text-first">?</span></h1>
            <div className='flex flex-col lg:flex-row items-center justify-center gap-10 w-full my-12'>
                <div className='w-full lg:w-1/2 h-auto md:h-[370px] lg:h-[460px] flex items-center justify-center flex-col md:flex-row lg:flex-row bg-gradient-to-b from-first to-black rounded-xl border'>
                    <figure className='w-full lg:w-1/2 md:w-1/2 h-full'>
                        <img src={part} alt="partner-image" className='w-full h-full bg-first' />
                    </figure>
                    <div className='w-full lg:w-1/2 md:w-1/2 h-full p-7 space-y-3  flex items-start justify-center flex-col text-white dark:text-gray-400'>
                ...
                <div className='w-full lg:w-1/2 h-auto md:h-[370px] lg:h-[460px] flex items-center justify-center flex-col md:flex-row lg:flex-row bg-gradient-to-b from-first to-black rounded-xl border'>
                    ...
                    <div className='w-full lg:w-1/2 md:w-1/2 h-auto p-7 space-y-3 flex items-start justify-center flex-col text-white dark:text-gray-400'>
                        <h1 className='text-2xl '>Become a Partner</h1>
